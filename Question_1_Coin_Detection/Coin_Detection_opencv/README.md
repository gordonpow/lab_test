...
##  專案簡介
本專案使用 **OpenCV** 傳統視覺處理技術，透過電腦內建視訊鏡頭（Webcam）即時偵測台灣硬幣（1元、5元、10元、50元），並計算畫面上硬幣的總金額。本系統特別針對硬幣偵測中常見的「數值跳動」與「陰影誤導」問題，開發了**穩定追蹤演算法**，提供更精準的計數結果。
